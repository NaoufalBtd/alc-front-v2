...
export class CommunityFeedbackComponent implements OnInit {
    ...
    sliderData = [
        {
            id: 1,
            img: 'assets/img/testimonial/home-3/testi-1.webp',
        ...
        {
            id: 2,
            img: 'assets/img/testimonial/home-3/testi-2.webp',
            name: 'Khadija Alioui',
        ...
        {
            id: 3,
            img: 'assets/img/testimonial/home-3/testi-3.webp',
            name: 'Khalid Zouani',
    ...
    hideOtherVideos() {
        ...
        const otherVideos = videoElement.contentDocument.querySelectorAll('.your-selector-for-other-videos');
